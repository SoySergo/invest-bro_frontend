        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-4">
              ...
              <div className="flex flex-col items-end gap-2 bg-card p-4 rounded-2xl shadow-sm border border-muted/40 min-w-[200px]">
                ...
                {paybackYears && (
                  <div className="text-sm font-medium flex items-center gap-1.5 text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 px-2.5 py-1 rounded-lg">
                    ...
                    <span>{paybackYears} Year Payback</span>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                <div className="p-5 bg-card border border-muted/40 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="text-2xl font-bold">
                    {Number(listing.yearlyRevenue || 0).toLocaleString()} <span className="text-sm font-normal text-muted-foreground">{listing.currency}</span>
                  </div>
                </div>
                ...
                <div className="p-5 bg-card border border-muted/40 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">
                    {Number(listing.yearlyProfit || 0).toLocaleString()} <span className="text-sm font-normal text-muted-foreground/80">{listing.currency}</span>
                  </div>
                </div>
